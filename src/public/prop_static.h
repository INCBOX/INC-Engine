...
#include "imt_material.h"   // for MaterialManager
#include "mathlib.h"                // for Vec3, Mat4

extern MaterialManager g_MaterialManager;
extern GLuint cubeVAO;  // declare cubeVAO as external, define it in your engine render init code

struct PropStatic {
    Vec3 position;
    std::string materialPath;

    void Draw(const Mat4& view, const Mat4& proj) const {
